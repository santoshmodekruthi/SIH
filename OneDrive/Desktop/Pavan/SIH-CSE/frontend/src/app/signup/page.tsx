  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-neutral-900 border border-neutral-800 rounded-2xl p-8">
        ...
        <h1 className="text-2xl font-bold text-center mb-2">Join FITZER AI</h1>
        <p className="text-neutral-400 text-center mb-8">Start your AI-powered fitness journey</p>
